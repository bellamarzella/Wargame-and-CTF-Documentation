...
| **23 → 24** | [Payload](/levels/bandit23/injectionScript.sh) | Created a custom shell script payload, made it executable, and dropped it into a watched cron folder to trick a background daemon into copying the password to an open directory. |
